...
total_reviews = 50000  # Target number of reviews
...
# Save to CSV
df.to_csv("livin_reviews.csv", index=False)

print(f"Scraping complete! {len(df)} reviews saved to 'livin_reviews.csv'.")
